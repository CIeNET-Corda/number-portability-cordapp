...
private class RPCClient: CliktCommand() {
    ...
    val flowName: String by option(help="The Flow Name (query/access/transfer)").default("query")
    val number: String by option(help="The number for the flow action").default("18612345678")
    val partyName: String by option(help="The CordaX500Name of the party for the flow action").default("CTCC")
